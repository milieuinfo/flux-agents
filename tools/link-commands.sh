...
# pipeline/agents/claude-code/.claude folder. Zo staan alle agent-definities op
# één plek (in flux-agents), maar zijn de commands beschikbaar als
# /develop, /review, /address in je project.
#
# Usage:
#   ./tools/link-commands.sh /path/to/flux-web-components
#
set -euo pipefail
...
SOURCE=".claude"
SOURCE_ABS="$AGENTS_FLUX_ROOT/pipeline/agents/claude-code/$SOURCE"
