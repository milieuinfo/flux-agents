...
Lees `state/sprints/<sprint>/tickets/$1/_status.json`. Vereist:
...
> - Jouw eigen vorige werk: `state/sprints/<sprint>/tickets/$1/code-changes.md`
> - Review feedback van vorige ronde: `state/sprints/<sprint>/tickets/$1/review-r{round-1}.md`
>
